...
import (
	...
	"github.com/Raghav847/greenlight/internal/data"
	"github.com/Raghav847/greenlight/internal/mailer"
	_ "github.com/lib/pq"
)
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "67735382bed6b8", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "dfb008f26410eb", "SMTP password")
